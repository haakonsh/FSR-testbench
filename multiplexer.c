...
// extern mux_t state1, state2, state3, state4, state5, state6, state7, state8, state9, state10, state11, state12;
...
// The 4 TS3A27518EPWR multilexers requires 5 control signals in order to multiplex 36 sensors.
